...
static const  AUX_VOLTAGE_MSG_SIZE = 2;
static const AUX_UPDATE_AUX_VOLTAGE_FREQ = 50;
static const SPI_TIMEOUT = 50;
static const AUX_NOMINAL_VOLTAGE = 12.0;
static const AUX_ADC_NOMINAL_OUTPUT = 0x32E; // Pattern = 2.63/3.3 * 0x3FF
