...
//Values here are swapped between M0 and M1 since the motor controllers in the car are currently swapped.
//If electrical swaps the controllers back to their original way, then swap M1 with M0 and vice versa.
#define M1_ID (0)
#define M0_ID (1)

#define M1_BASE_CAN_ID (0x400)
#define M1_STATUS_CAN_ID (0x401)
#define M1_BUS_CAN_ID (0x402)
#define M1_VELOCITY_CAN_ID (0x403)
#define M1_PHASE_CURRENT_CAN_ID (0x404)
#define M1_VOLTAGE_VECTOR_CAN_ID (0x405)
#define M1_CURRENT_VECTOR_CAN_ID (0x406)
#define M1_BACKEMF_CAN_ID (0x407)
#define M1_15V_VOLTAGE_RAIL_CAN_ID (0x408)
#define M1_3_3V_1_9V_VOLTAGE_RAIL_CAN_ID (0x409)
#define M1_HEATSINK_TEMPERATURE_CAN_ID (0x40B)
#define M1_DSP_BOARD_TEMPERATURE_CAN_ID (0x40C)
#define M1_ODOMETER_BUS_AMPHOURS_CAN_ID (0x40E)
#define M1_SLIP_SPEED_CAN_ID (0x417)
#define M0_BASE_CAN_ID (0x420)
#define M0_STATUS_CAN_ID (0x421)
#define M0_BUS_CAN_ID (0x422)
#define M0_VELOCITY_CAN_ID (0x423)
#define M0_PHASE_CURRENT_CAN_ID (0x424)
#define M0_VOLTAGE_VECTOR_CAN_ID (0x425)
#define M0_CURRENT_VECTOR_CAN_ID (0x426)
#define M0_BACKEMF_CAN_ID (0x427)
#define M0_15V_VOLTAGE_RAIL_CAN_ID (0x428)
#define M0_3_3V_1_9V_VOLTAGE_RAIL_CAN_ID (0x429)
#define M0_HEATSINK_TEMPERATURE_CAN_ID (0x42B)
#define M0_DSP_BOARD_TEMPERATURE_CAN_ID (0x42C)
#define M0_ODOMETER_BUS_AMPHOURS_CAN_ID (0x42E)
#define M0_SLIP_SPEED_CAN_ID (0x437)
