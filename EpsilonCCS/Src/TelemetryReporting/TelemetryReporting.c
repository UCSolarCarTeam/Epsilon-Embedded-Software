...
void sendMotorDetails(int n)
{
    ...
    switch(n)
    {
        case 0:
            ...
            writeFloatIntoArray(packetPayload, 17, motor0DetailsData.motorCurrentImaginary);
            writeFloatIntoArray(packetPayload, 21, motor0DetailsData.backEmfReal);
        ...
        case 1:
            ...
            writeFloatIntoArray(packetPayload, 17, motor1DetailsData.motorCurrentImaginary);
            writeFloatIntoArray(packetPayload, 21, motor1DetailsData.backEmfReal);
