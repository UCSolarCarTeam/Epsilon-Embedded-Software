...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RIGHT_SIG_Pin|LEFT_SIG_Pin|BRAKE_Pin|HEAD_Pin
  ...
  /*Configure GPIO pins : RIGHT_SIG_Pin LEFT_SIG_Pin BRAKE_Pin HEAD_Pin
                           STROBE_Pin */
  GPIO_InitStruct.Pin = RIGHT_SIG_Pin|LEFT_SIG_Pin|BRAKE_Pin|HEAD_Pin
                          |STROBE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
