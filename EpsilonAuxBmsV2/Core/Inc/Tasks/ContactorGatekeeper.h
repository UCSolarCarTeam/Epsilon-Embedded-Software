...
static const unsigned int COMMON_CHECK_CONTACTOR_DELAY = 500; // 0.5s
static const unsigned int COMMON_RETRY_CONTACTOR_DELAY = 1000; // 1s
static const unsigned int NON_COMMON_CONTACTOR_CHECK_DELAY = 1500; // 30s
static const unsigned int CONTACTOR_DELAY = 10000; // 10s
