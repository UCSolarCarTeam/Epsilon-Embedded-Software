...
#define ORION_CHARGE_ENABLE_SENSE_Pin CHARGE_ENABLE_SENSE_Pin
#define ORION_CHARGE_ENABLE_SENSE_GPIO_Port CHARGE_ENABLE_SENSE_GPIO_Port
#define ORION_DISCHARGE_ENABLE_SENSE_Pin DISCHARGE_ENABLE_SENSE_Pin
#define ORION_DISCHARGE_ENABLE_SENSE_GPIO_Port DISCHARGE_ENABLE_SENSE_GPIO_Port
